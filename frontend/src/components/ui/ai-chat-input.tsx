...
const AIChatInput = ({ onSend, isLoading = false, placeholder }: AIChatInputProps) => {
  ...
  const activePlaceholders = placeholder ? [placeholder] : PLACEHOLDERS;
  ...
  }, [isActive, inputValue, activePlaceholders.length, placeholder]);
    ...
    >
      <div className="flex flex-col items-stretch w-full h-full">
        ...
        <div className="flex items-center gap-2 p-3 rounded-full bg-white w-full">
          <button
            className="p-3 rounded-full hover:bg-gray-100 transition text-[#0b0b0e]"
            title="Attach file"
            type="button"
            tabIndex={-1}
          >
          ...
          <div className="relative flex-1">
            <input
              ...
              disabled={isLoading}
              className="flex-1 border-0 outline-0 rounded-md py-2 text-base bg-transparent w-full font-normal text-[#0b0b0e] disabled:opacity-50"
          ...
          <button
            ...
            className="flex items-center gap-1 bg-[#0b0b0e] hover:bg-zinc-700 text-white p-3 rounded-full font-medium justify-center disabled:opacity-40 transition"
            title="Send"
            type="button"
          >
            <Send size={18} />
          ...
          <div className="flex gap-3 items-center">
            <button
              className={`flex items-center gap-1 px-4 py-2 rounded-full transition-all font-medium group ${
                thinkActive
                  ? "bg-accent/10 outline outline-accent/40 text-accent"
            ...
            >
              <Lightbulb className="transition-all" size={18} />
              Think
            </button>
